Hostsharing-Ansible-Taiga
=========================

This Ansible playbook will install the latest Taiga release on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-Taiga.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-Taiga
